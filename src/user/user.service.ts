...
import { UserGenderDto } from './dto/user-gender.dto';
...
export class UserService {
    ...
    async addTwet(userTwetDto: UserGenderDto): Promise<UserResponseDto> {
    ...
    async removeTwet(userTwetDto: UserGenderDto): Promise<UserResponseDto> {
        const user = await this.userModel.findById(userTwetDto.userId).exec();
        UtilsService.checkModel(
            user,
            `user:${userTwetDto.userId} not found`,
